...
export default function PracticeHeader({ video, onBack }: PracticeHeaderProps) {
  return (
    <header className="h-14 bg-white/80 backdrop-blur-md border-b border-slate-200 flex items-center justify-between px-4 shrink-0 z-10">
